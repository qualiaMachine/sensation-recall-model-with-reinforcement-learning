function [beta, LL, Q] = rlfit(Qfun, choice, outcome,attentionWeights, lb, ub, niter)
...
% softmax
LLfun = @(x, choice, z) LL_softmax(x(1) * Qfun(x(2:end), choice, z,attentionWeights), nan,choice);
...
% get action values
% keyboard
Q = Qfun(beta(2:end), choice, z,attentionWeights);
