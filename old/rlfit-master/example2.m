...
pars.figDir = 'T:\RLmodel\analysisFigs';
saveDir = 'T:\RLmodel\';
%% Set params 
...
for trinaryPupilMeasSetting=[2];%,1,3]; % 3=subtract postDecision-preDecision; 2=preDecision, 1=postDecision
    ...
    for modelNum = [3]%6:9,2,3]
        ...
        if loadData
            load([saveDir filesep 'ppData_model' num2str(modelNum) '_antic' num2str(pars.grabAnticResp) '_cond' num2str(condition) '_trinaryPupilMeasSetting' num2str(trinaryPupilMeasSetting) '.mat'],'ppData')
%             load([saveDir filesep 'qDiffRel_ppData_model' num2str(modelNum) '_antic' num2str(pars.grabAnticResp) '_cond' num2str(condition) '_trinaryPupilMeasSetting' num2str(trinaryPupilMeasSetting) '.mat'],'ppData')
        else
            save([saveDir filesep 'qDiffRel_ppData_model' num2str(modelNum) '_antic' num2str(pars.grabAnticResp) '_cond' num2str(condition) '_trinaryPupilMeasSetting' num2str(trinaryPupilMeasSetting) '.mat'],'ppData')
        end
        if ~plotStuff
            continue
        end
        ...
        %     saveas(gcf,[pars.figDir filesep 'avgPupilDiamVsBEta_stimOnsetBool' num2str(gatherStimOnset) '_meas' num2str(measOpts) '_cond' num2str(condition) '_modelFreeVsModelBasedAvgPupilSize.png'])
        ...
        xlabel('Alpha Value','FontSize',12)
        set(gca,'YTickLabel',{'','','','','','',''})
%         saveas(gcf,[pars.figDir filesep 'paramCorrelations_beta_alpha_exploitCt_pupilAvg_trinaryPupilMeasSetting' num2str(trinaryPupilMeasSetting) '_cond' num2str(condition) '_modelFreeVsModelBasedAvgPupilSize.png'])
...
%         saveas(gcf,[pars.figDir filesep 'mainEffects' '_model_' num2str(modelNum) '_trinaryPupilMeasSetting' num2str(trinaryPupilMeasSetting) '_cond' num2str(condition) '_modelFreeVsModelBasedAvgPupilSize.png'])
        ...
        title('')
%         saveas(gcf,[pars.figDir filesep 'linearModel' '_model_' num2str(modelNum) '_trinaryPupilMeasSetting' num2str(trinaryPupilMeasSetting) '_cond' num2str(condition) '_modelFreeVsModelBasedAvgPupilSize.png'])
...
%         linearInd = sub2ind(matrixSize, rowSub, colSub)
        ...
        title('')
        ylim([yMin,yMax])
%         saveas(gcf,[pars.figDir filesep 'w-outcome-interaction' '_model_' num2str(modelNum) '_trinaryPupilMeasSetting' num2str(trinaryPupilMeasSetting) '_cond' num2str(condition) '_modelFreeVsModelBasedAvgPupilSize.png'])
        ...
        set(gca,'yticklabel',{'','','','','','',''})
%         legend(gca,'off');
%         saveas(gcf,[pars.figDir filesep 'linearModel_exploreExploitInteraction' '_model_' num2str(modelNum) '_trinaryPupilMeasSetting' num2str(trinaryPupilMeasSetting) '_cond' num2str(condition) '_modelFreeVsModelBasedAvgPupilSize.png'])
...
%         set(gca,'yticklabel',{'','','','','','',''})
        ...
        ylim([yMin,yMax])
        set(gca,'yticklabel',{'','','','','','',''})
%         saveas(gcf,[pars.figDir filesep 'linearModel_wInteraction' '_model_' num2str(modelNum) '_trinaryPupilMeasSetting' num2str(trinaryPupilMeasSetting) '_cond' num2str(condition) '_modelFreeVsModelBasedAvgPupilSize.png'])
        ...
        % saveas(gcf,[pars.figDir filesep 'MF-MB-pp-distributione_stimOnsetBool' num2str(gatherStimOnset) '_meas' num2str(measOpts) '_cond' num2str(condition) '_modelFreeVsModelBasedAvgPupilSize.png'])
    ...
    %     plot(lm)
        % titleAppend='model-free';
        % saveas(gcf,[pars.figDir filesep titleAppend '_stimOnsetBool' num2str(gatherStimOnset) '_meas' num2str(measOpts) '_cond' num2str(condition) '_modelFreeVsModelBasedAvgPupilSize.png'])
        % titleAppend='model-based';
        % saveas(gcf,[pars.figDir filesep titleAppend '_stimOnsetBool' num2str(gatherStimOnset) '_meas' num2str(measOpts) '_cond' num2str(condition) '_modelFreeVsModelBasedAvgPupilSize.png'])
        saveas(gcf,[pars.figDir filesep 'MF_BM_Qdifs_v_pupilSizes_stimOnsetBool' num2str(gatherStimOnset) '_meas' num2str(measOpts) '_cond' num2str(condition) '_modelFreeVsModelBasedAvgPupilSize.png'])
        % saveas(gcf,[pars.figDir filesep 'MF_BM_Qdifs_v_pupilSizes_stimOnsetBool' num2str(gatherStimOnset) '_meas' num2str(measOpts) '_cond' num2str(condition) '_modelFreeVsModelBasedAvgPupilSize.tif'])
    ...
    %     [h,p,ci,stats] = ttest2(datas{2,1}(:),datas{2,2}(:))
        ...
        ylim([1800,2100])
        set(gca,'XTickLabel',{'Model-Free','Model-Based'})
        saveas(gcf,[pars.figDir filesep 'stimOnsetBool' num2str(gatherStimOnset) '_meas' num2str(measOpts) '_cond' num2str(condition) '_modelFreeVsModelBasedAvgPupilSize_splitByExploreOrExploit.png'])
        ...
        set(gca,'XTickLabel',{'Model-Free','Model-Based'})
        saveas(gcf,[pars.figDir filesep 'stimOnsetBool' num2str(gatherStimOnset) '_meas' num2str(measOpts) '_cond' num2str(condition) '_modelFreeVsModelBasedAvgPupilSize.png'])
