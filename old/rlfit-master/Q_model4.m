function prA=Q_model4(modelParams,action1,action2,payoff,states,pupilSizes)
...
pupilExploreCoef = modelParams(5); % weight parameter between TD and MB values
pupilExploitCoef = modelParams(6); % weight parameter between TD and MB values
...
%             alpha = (origParam/2) + (exploit*attentionWeights(t)*pupilExploreCoef);
            alpha = (origParam)*(exploit*attentionWeights(t)*pupilExploreCoef);
